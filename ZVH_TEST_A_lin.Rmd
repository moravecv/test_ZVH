...
```
Odtok z povodí je $Q$ = `r round(PR2_res$Qout, 2)` $m^{3}$

#### Příklad 3
```{r, echo = FALSE}
PR3_res <- list()
PR3_res$S1 <- round((pi * PR3$D1^2)/4, 2)
PR3_res$Q1 <- round(PR3$v1 * PR3_res$S1, 2)
PR3_res$Q2 <- round(PR3_res$Q1, 2)
PR3_res$S2 <- round((pi * PR3$D2^2)/4, 2)
PR3_res$v2 <- round(PR3_res$Q2 / PR3_res$S2, 2)
PR3_res$S3 <- round(PR3_res$Q2 * 2 / PR3$v3, 2)
PR3_res$D3 <- round(sqrt((4 * PR3_res$S3) / pi), 2)
PR3_res$Q4 <- round(PR3_res$Q2 / 4, 2)
PR3_res$S4 <- round(PR3_res$S3 / 3, 2)
PR3_res$v4 <- round(PR3_res$Q4 / PR3_res$S4, 2)
PR3_res$D4 <- round(sqrt((4 * PR3_res$S4) / pi), 2)
```
...
\hline
Profil                 & 1              & 2               & 3               & 4               \\ \hline
v (m$\cdot$ s $^{-1}$) & `r PR3$v1`     & `r PR3_res$v2`  & `r PR3$v3`      & `r PR3_res$v4`  \\ \hline
Q (l$\cdot$ s $^{-1}$) & `r PR3_res$Q1` & `r PR3_res$Q2`  & 2Q$_{2}$        & Q$_2$/4         \\ \hline
D (cm)                 & `r PR3$D1`     & `r PR3$D2`      & `r PR3_res$D3`  & `r PR3_res$D4`  \\ \hline
S (cm$^{2}$)           & `r PR3_res$S1` & `r PR3_res$S2`  & `r PR3_res$S3`  & 1/3 S$_3$       \\ \hline
\end{tabular}
\end{table}
...
```{r, echo = FALSE}
PR5_res <- list()
PR5_res$XI_Qminm3 <- round(PR5$Qmin * 10^(-3) * 60 * 60 * 24 * 30, 2)
PR5_res$XII_Qminm3 <- round(PR5$Qmin * 10^(-3) * 60 * 60 * 24 * 31, 2)
PR5_res$I_Qminm3 <- round(PR5$Qmin * 10^(-3) * 60 * 60 * 24 * 31, 2)

PR5_res$XI_Qinm3 <- round(PR5$XI_Qin * 10^(-3) * 60 * 60 * 24 * 30, 2)
PR5_res$XII_Qinm3 <- round(PR5$XII_Qin * 10^(-3) * 60 * 60 * 24 * 31, 2)
PR5_res$I_Qinm3 <- round(PR5$I_Qin * 10^(-3) * 60 * 60 * 24 * 31, 2)
...
PR5_res$XI_bil <- round(PR5_res$XI_Qinm3 - PR5_res$XI_Qminm3 - PR5_res$XI_ETm3, 2)
PR5_res$XII_bil <- round(PR5_res$XII_Qinm3 - PR5_res$XII_Qminm3 - PR5_res$XII_ETm3, 2) 
PR5_res$I_bil <- round(PR5_res$I_Qinm3 - PR5_res$I_Qminm3 - PR5_res$I_ETm3, 2)

PR5_res$XI_zas <- round(PR5$V + PR5_res$XI_bil, 2)
PR5_res$XII_zas <- round(PR5_res$XI_zas + PR5_res$XII_bil, 2)
PR5_res$I_zas <- round(PR5_res$XII_zas + PR5_res$I_bil, 2)
```
...
výpar (\%)                              &`r PR5$XI_ET`        &`r PR5$XII_ET`      &`r PR5$I_ET`            \\ \hline
min. zůst. průtok (l$\cdot$ s$^{-1}$)   &`r PR5$Qmin`         &`r PR5$Qmin`        &`r PR5$Qmin`            \\ \hline
min. zůst. průtok (m$^3$)               &`r as.character(PR5_res$XI_Qminm3)`&`r as.character(PR5_res$XI_Qminm3)`&`r as.character(PR5_res$XI_Qminm3)`\\ \hline
